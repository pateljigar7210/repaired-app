    ...
    <View style={tw`bg-white text-[#232323] w-10/12 mx-auto rounded-[20px] shadow-md mb-15`}>
      <View style={tw`flex flex-col justify-between items-start p-8 px-9`}>
        <View style={tw`flex flex-row justify-between items-center w-full`}>
          <Text style={tw`text-2xl font-bold`}>Watch Resize</Text>
      ...
      <Image 
        source={require('../../assets/backgroundImages/RepairsCards/watch.png')}
        style={tw`w-58 h-76 absolute -top-8 -right-5 opacity-60`}
      />
    </View>
  )
}
