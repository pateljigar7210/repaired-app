        ...
        <View style={tw`flex-1 my-20`}>
          ...
          <View style={tw`mt-8`}>
            <View style={tw`flex-row justify-between items-center px-6 py-2 bg-[#F7F7FC]`}>
              <Text style={tw`text-xl font-light`}>Set Stone</Text>
              <Text style={tw`text-xl font-light`}>$20</Text>
            </View>

            <View style={tw`mt-6 mx-auto w-10/12`}>
              <Text style={tw`text-base font-semibold`}>I have my stone</Text>
              <View style={tw`flex-col items-center justify-between`}>
                <View style={tw`flex-row w-10/12 mx-auto justify-between items-center mt-4`}>
                <Text>Set Diamond</Text>
                <NumericInput 
                  value={value} 
              ...
              <View style={tw`flex-row w-10/12 mx-auto justify-between items-center`}>
                <Text>Set Gemstone</Text>
                <NumericInput 
                  value={value} 
                  onChange={value => setValue(value)} 
                  totalWidth={130} 
              ...
              <View style={tw`flex-row items-end mt-4`}>
                <Checkbox
                  style={tw`mt-4 border border-1 border-[#DADADA] mr-4`}
                  value={isChecked}
                  onValueChange={setChecked}
                  color={isChecked ? '#4630EB' : undefined}
                />
                <Text>I lost my stone</Text>
              </View>
              {isChecked && (
              ...
              <View style={tw`mt-6 flex-row items-center justify-between`}>
                <Text style={tw`text-base font-semibold`}>Desired Ring Size</Text>
                <NumericInput 
                  value={value} 
                  onChange={value => setValue(value)} 
                  totalWidth={130} 
