        ...
        <View style={tw`flex-1 my-20`}>
          ...
          <View style={tw`mt-8`}>
            <View style={tw`flex-row justify-between items-center px-6 py-2 bg-[#F7F7FC]`}>
              <Text style={tw`text-xl font-light`}>Shank Repair</Text>
            ...
            <View style={tw`mt-6 mx-auto w-10/12`}>
              <View style={tw`flex-row items-center justify-between ${isChecked ? "opacity-20" : ""}`}>
                <Text style={tw`text-base font-semibold`}>Current Ring Size</Text>
                <NumericInput 
                  value={value} 
              ...
              <View style={tw`flex-row items-end mt-4`}>
                ...
                />
                <Text>I am not sure about the current ring size</Text>
              </View>
              {isChecked && (
