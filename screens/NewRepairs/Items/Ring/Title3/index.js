        ...
        <View style={tw`flex-1 my-20`}>
          ...
          <View style={tw`mt-8`}>
            <View style={tw`flex-row justify-between items-center px-6 py-2 bg-[#F7F7FC]`}>
              <Text style={tw`text-xl font-light`}>Stone Related Repair</Text>
            ...
            <View style={tw`mt-6 mx-auto w-10/12`}>
              <View style={tw`flex-col ml-8`}>
                <View style={tw`flex-row items-center`}>
                  ...
                  />
                  <Text>Stone Tightening</Text>
                </View>
                {isChecked2 && (
                   <View style={tw`mt-3 flex-row items-center justify-between`}>
                    <Text style={tw`text-base`}>How Many Stones</Text>
                    <NumericInput 
                      value={value} 
                ...
                <View style={tw`flex-row items-center mt-4`}>
                  ...
                  />
                  <Text>Rebuild Prongs</Text>
                </View>
                {isChecked4 && (
                  <View style={tw`mt-3 flex-row items-center justify-between`}>
                    <Text style={tw`text-base`}>How Many Prongs</Text>
                    <NumericInput 
                      value={value} 
                      onChange={value => setValue(value)} 
                      totalWidth={130} 
